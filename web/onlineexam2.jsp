<%-- 
    Document   : onlineexam2
    Created on : Sep 23, 2019, 7:29:00 PM
    Author     : Harsh Archit
--%>
...
<nav class="navbar navbar-default">
    ...
    <ul class="nav navbar-nav" style="margin-left: 400px;">
      ...
      <li><a href="#" data-toggle="modal" data-target="#mymod2">SignUp</a></li>
...
<div class="modal fade" id="mymod2">
    <form action="insertuserdetails" method="post" enctype="multipart/form-data">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
            	...
            	<div class="form-group">
            		<label>Email</label>
                        <input required="" type="email" name="email" placeholder="Email" class="form-control">
                                    ...
                                    <div class="form-group">
            		<label>Contact</label>
                        <input required="" type="number" name="contact" placeholder="Contact" class="form-control">
            	</div>
                                    <div class="form-group">
            		<label>Photo</label>
                        <input required="" type="file" name="photo" placeholder="Email" class="form-control">
            	</div>
                                    <div class="form-group">
            		<label>Password</label>
                        <input required="" type="password" name="pass" placeholder="Password" class="form-control">
